...
<body>
    <div class="home-container">
        <div class="home-inner">
                ...
                <section class="section-one" id="top">
                    ...
                    <div class="right col-12 col-md-6">
                        <div class="right-inner">
                            <iframe class="mb-3" width="400" height="225" src="https://www.youtube.com/embed/SAJemnJWRTM?rel=0&amp;showinfo=0" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen=""></iframe>
                            <p class="mt-3">Times have changed, but events aren't going away. They're just taking different forms!</p>
                            <p><a href="#faq" class="btn btn-link btn-lg home-link pl-0 scroll-anchor">Learn More <i class="fas fa-chevron-right align-middle"></i></a></p>
                        </div>
                    </div>
                </section>
            ...
            <footer>
                <div class="row">
                    <ul class="col-12 col-md-6 offset-md-3 col-lg-4 offset-lg-4 footer-links d-flex justify-content-around pb-3">
